...
4. 执行:git clone https://github.com/sqeven/siteproxy.git; cd siteproxy
...
2. npm install -g now
3. git clone https://github.com/sqeven/siteproxy.git
4. cd siteproxy
5. now
...
4. git clone https://github.com/sqeven/siteproxy.git; cd siteproxy
